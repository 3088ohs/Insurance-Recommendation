                ...
                <ul class="slidelist">
                    ...
                    <li class="slideitem">
                        <a>
                            <div class="textbox">
                                ...
                                <div><input type="number" name="BP" id="BP" placeholder="혈압을 입력해주세요.">
                                <a>&nbsp; mmHg</a></div>
                            </div>
                        </a>
                    </li>
                        ...
                        <a>
                            ...
                            <div class="textbox">
                                ...
                                <ul>
                                    ...
                                    <li>
                                        혈중산소포화도가 90~95일 때는 저산소증이 나타납니다.
                                    </li>
                                    <li>
                                        혈중산소포화도가 90 이하로 떨어지면 저산소증으로 호흡이 곤란한 상태가 됩니다.
                                    </li>
                                </ul>
                                <div><input type="number" name="BOS" id="BOS" placeholder="혈중산소포화도를 입력해주세요.">
                                    <a>&nbsp; %</a></div>
                            </div>
                        </a>
                    </li>
                    <li class="slideitem">
                        <a>
                            ...
                            <div class="textbox">
                                ...
                                <div><input type="number" name="BFP" id="BFP" value="0">
                                    <a>&nbsp; %</a></div>
                            </div>
                        </a>
                    </li>
                        ...
                        <a>
                            ...
                            <div class="textbox">
                                ...
                                <div>
                                    ...
                                    <a>&nbsp; kg</a><br>
                                    골격근량 : <input type="number" name="SMM" id="SMM" placeholder="골격근량">
                                    <a>&nbsp; kg</a></div>
                            </div>
                            <script>
                    ...
                    <li class="slideitem">
                        <a>
                            ...
                            <div class="textbox">
                                ...
                                <div><input type="number" name="MBW" id="MBW" placeholder="체수분량을 입력해주세요.">
                                    <a>&nbsp; %</a></div>
                            </div>
                        </a>
                    </li>
                    <li class="slideitem">
                        <a>
                            ...
                            <div class="textbox">
                                <h3>기초대사량</h3>
                                <p><a class="name">@@</a> 회원님의 체중, 키, 나이, 성별로 계산된 기초대사량은 <a id="calcBM"></a> kcal 입니다.<br>
                                    맞으시다면 다음으로 넘어가 주시고 수정이 필요할 시 수정해주세요.
                                </p>
                                <ul>
                                ...
                                <div><input type="number" name="BM" id="BM" value="1728">
                                    <a>&nbsp; kcal</a></div>
                            </div>
                        </a>
                    </li>
                    ...
                    <div class="slide-control">
                        ...
                        <div>
                            ...
                            <label id="label8" for="slide09" class="submit" onclick="showResult()"></label>
                        </div>
                    </div>
                        <script>
